...
class PreTrainedTokenizer(object):
    ...
    def tokenize(self, text, **kwargs):
        ...
        def split_on_tokens(tok_list, text):
            ...
            # return list(itertools.chain.from_iterable(self._tokenize(text_list, **kwargs)))
            return self._tokenize(text_list, **kwargs)
        # print("-------self.added_tokens_encoder.keys()-----------")
        # print(self.added_tokens_encoder)
        # print("-------all_special_tokens-----------")
        # print(all_special_tokens)
        # print("-------text-----------")
    ...
    def encode_plus(self,
        ...
        # print("-------------------------------encode_plus_first_start-----------------------------")
        first_ids = get_input_ids(text)
        # print("-------------------------------encode_plus_first_end-----------------------------")
        # print("-------------------------------encode_plus_second_start-----------------------------")
        second_ids = get_input_ids(
            text_pair) if text_pair is not None else None
        # print("-------------------------------encode_plus_second_end-----------------------------")
